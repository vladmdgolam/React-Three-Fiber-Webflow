...
class AsciiEffect {
  constructor(renderer, charSet = ' .:-=+*#%@', options = {}) {
    ...
    let fLetterSpacing = options['letterSpacing'] || 0
    const scale = options['scaleSym'] || 1
    ...
    function initAsciiSize() {
      iWidth = Math.floor(width * fS * fResolution)
      iHeight = Math.floor(height * fS2 * fResolution)
    ...
    const fFontSize = (2 / fResolution) * iScale * scale
    const fLineHeight = (2 / fResolution) * iScale // / scale
